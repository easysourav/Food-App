...
const Placeorder = ({ navigation, route }) => {
    ...
    useEffect(() => {
        if (cartdata != null) {
            ...
            setTotalCost(JSON.parse(JSON.stringify(totalfoodprice)))
        }
    }, [cartdata])
    ...
    return (
        <ScrollView nestedScrollEnabled={true} style={styles.containerout}>
            ...
            <View style={styles.container}>
                ...
                <FlatList horizontal style={styles.c1} data={orderdata.cart} renderItem={
                    ({ item }) => {
                        return (
