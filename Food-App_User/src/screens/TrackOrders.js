...
const TrackOrders = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView nestedScrollEnabled={true} style={styles.containerin}>
                        ...
                        return (
                            <View style={styles.order} key={index}>
                                ...
                                <View style={styles.row1}>
                                    <Text style={styles.ordertxt1}>Waiter's Name & Table Number</Text>
                                    {
                                ...
                                <FlatList horizontal style={styles.c1} data={order.orderdata} renderItem={
                                    ({ item }) => {
                                        return (
