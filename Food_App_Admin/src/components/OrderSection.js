        ...
        <div className="order-section">
            ...
            <div className='order__container'>
                <div className="order-row_card1">
                    ...
                    <p className='ordertxt'>Food Delivery Status</p>
                    <p className='ordertxt'>Waiter Name</p>
                    <p className='ordertxt'>Table Number</p>
                    ...
                    {allorders.filter((val) => {
                        ...
                        <div className="order-row_card">
                            ...
                            {order.deliveryboy_name ? <p className='ordertxt'> {order.deliveryboy_name}</p> :
                                <input type="text" placeholder="Enter Waiter's Name" className='orderinput' onBlur={(e) => changeDeliveryboyName(order.orderid, order, e.target.value)} />
                            }
                            {
                                order.deliveryboy_phone ? <p className='ordertxt'> {order.deliveryboy_phone}</p> :
                                    <input type="text" placeholder="Enter Table Number" onBlur={(e) => changeDeliveryboyPhone(order.orderid, order, e.target.value)} className='orderinput' />
                            }
